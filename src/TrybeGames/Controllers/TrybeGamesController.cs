...
public class TrybeGamesController
{
    ...
    public void AddPlayer()
    {
       try
       {
        ...
        players.Add(new Player { Id = playerId, Name = playerName});
       }
        catch (Exception ex)
        {
    ...
    public void AddGameStudio()
    {
        try
        {
            ...
            int gameStudioId = gameStudios.Count + 1;
            gameStudios.Add(new GameStudio { Id = gameStudioId, Name = gameStudioName});
        }
        catch (Exception ex)
        {
            Console.WriteLine(ex.Message);
    ...
    public void AddGame()
    {
        try
        {
            ...
            DateTime gameReleaseDate = DateTime.ParseExact(Console.ReadLine(), "dd/MM/yyyy", CultureInfo.InvariantCulture);
